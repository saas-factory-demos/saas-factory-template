...
export type PresetKey =
  ...
  | 'crowdfund-energy'
  | 'realestate-prestige'
  // @gen-extended-presets:begin-union
  | 'saas-general'
  | 'micro-saas'
  | 'e-commerce'
  | 'e-commerce-luxury'
  ...
  | 'chat-and-messaging-app'
  | 'notes-and-writing-app'
  | 'habit-tracker'
  ...
  | 'timer-and-pomodoro'
  | 'parenting-and-baby-tracker'
  | 'scanner-and-document-manager'
  | 'calendar-and-scheduling-app'
  | 'password-manager'
  | 'expense-splitter-bill-split'
  | 'voice-recorder-and-memo'
  | 'bookmark-and-read-later'
  | 'translator-app'
  | 'calculator-and-unit-converter'
  | 'alarm-and-world-clock'
  | 'file-manager-and-transfer'
  | 'email-client'
  | 'casual-puzzle-game'
  | 'trivia-and-quiz-game'
  | 'card-and-board-game'
  | 'idle-and-clicker-game'
  | 'word-and-crossword-game'
  | 'arcade-and-retro-game'
  | 'photo-editor-and-filters'
  | 'short-video-editor'
  | 'drawing-and-sketching-canvas'
  | 'music-creation-and-beat-maker'
  | 'meme-and-sticker-maker'
  | 'ai-photo-and-avatar-generator'
  | 'link-in-bio-page-builder'
  | 'wardrobe-and-outfit-planner'
  | 'plant-care-tracker'
  | 'book-and-reading-tracker'
  | 'couple-and-relationship-app'
  | 'family-calendar-and-chores'
  | 'mood-tracker'
  | 'gift-and-wishlist'
  | 'running-and-cycling-gps'
  | 'yoga-and-stretching-guide'
  | 'sleep-tracker'
  | 'calorie-and-nutrition-counter'
  | 'period-and-cycle-tracker'
  | 'medication-and-pill-reminder'
  | 'water-and-hydration-reminder'
  | 'fasting-and-intermittent-timer'
  | 'anonymous-community-confession'
  | 'local-events-and-discovery'
  | 'study-together-virtual-coworking'
  | 'coding-challenge-and-practice'
  | 'kids-learning-abc-and-math'
  | 'music-instrument-learning'
  | 'parking-finder'
  | 'public-transit-guide'
  | 'road-trip-planner'
  | 'vpn-and-privacy-tool'
  | 'emergency-sos-and-safety'
  | 'wallpaper-and-theme-app'
  | 'white-noise-and-ambient-sound'
  | 'home-decoration-and-interior-design'
  // @gen-extended-presets:end-union
  ;

/** 20 個策展 PresetKey + 161 個 ui-ux-pro-max 擴充 = 181 個 runtime 列表。 */
export const PRESET_KEYS = [
  ...
  'crowdfund-energy',
  'realestate-prestige',
  // @gen-extended-presets:begin-array
  'saas-general',
  'micro-saas',
  'e-commerce',
  'e-commerce-luxury',
  ...
  'white-noise-and-ambient-sound',
  'home-decoration-and-interior-design',
  // @gen-extended-presets:end-array
