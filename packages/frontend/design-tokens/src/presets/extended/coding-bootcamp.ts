...
/**
 * Coding Bootcamp（ui-ux-pro-max 擴充）。
 *
 * Palette 自動生成：primary #0F172A / accent #22C55E / surface #020617。
 * 備註：Terminal dark + success green
 */
export const codingBootcamp: DesignTokens = createPreset({
  meta: {
    name: 'coding-bootcamp',
    displayName: 'Coding Bootcamp',
    description: 'Coding Bootcamp — ui-ux-pro-max 擴充 palette',
    version: '1.0.0',
